...
HD_PWD='C:/Users/Caetano/Desktop/PED1/Semana 13/Trabalho_6_Grupo_12/Trabalho_6_Grupo_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log registrador16bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source registrador16bits.tcl
