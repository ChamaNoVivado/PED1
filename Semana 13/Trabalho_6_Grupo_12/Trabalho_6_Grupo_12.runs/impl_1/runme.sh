...
HD_PWD='C:/Users/Caetano/Desktop/PED1/Semana 13/Trabalho_6_Grupo_12/Trabalho_6_Grupo_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log registrador16bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source registrador16bits.tcl -notrace
